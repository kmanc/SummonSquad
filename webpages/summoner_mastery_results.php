		...
		<h4>
			...
			<h2 class="error"><?php 
				if ($status != 0) {
					...
					echo '<br>command run ' . $command;
					echo '<br>results from script ' . $results;
					echo '<br>myoutput array ' . array_values($my_output);
					echo '<br>Status error: ' . $status . '. Something went wrong.<br> Make sure all of your summoner names are spelled correctly.<br> Press the back button or click <a href="../index.html"><button class="buttonAdd">   Here   </button></a> to go back';
				}
//				else {
