...
class RiotAPI(object):
    ...
    def request_summoner(self, api_url, params={}):
    ...
    def request_mastery(self, api_url, params={}):
        args = {'api_key': self.api_key}
        for key, value in params.items():
            if key not in args:
                args[key] = value
    ...
    def request_top_mastery(self, api_url, params={}):
        args = {'api_key': self.api_key}
        for key, value in params.items():
            if key not in args:
                args[key] = value
    ...
    def request_champion_role(self, api_url, params={}):
        args = {'api_key': self.api_key}
        for key, value in params.items():
            if key not in args:
                args[key] = value
    ...
    def request_champion_name(self, champIdizzle):
        args = {'api_key': self.api_key}
        response = requests.get(
    ...
    def get_summoner_by_name(self, name):
        ...
        return self.request_summoner(api_url)
    ...
    def get_summoner_mastery_data(self, id):
        ...
        return self.request_mastery(api_url)
    ...
    def get_top_mastery_data(self, id, champs):
        ...
        return self.request_top_mastery(api_url, {'count': champs})
    ...
    def get_champion_role(self, id, champList):
        ...
        return self.request_champion_role(api_url, {'championIds': champList, 'rankedQueues': queues})
    ...
    def get_champion_name(self, champIdizzle):
        ...
        return self.request_champion_name(champIdizzle)
